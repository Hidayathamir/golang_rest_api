...
func (_m *IProductRepository) AddProduct(productInput dto.AddProductRequest) (dto.AddProductResponse, error) {
...
func (_m *IProductRepository) GetProducts(queryParam repository.GetProductsQueryParam) ([]dto.GetProductResponse, error) {
